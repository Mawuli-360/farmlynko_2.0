...
class RentMachineryScreen extends ConsumerStatefulWidget {
  const RentMachineryScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<RentMachineryScreen> createState() =>
      _RentMachineryScreenState();
}

class _RentMachineryScreenState extends ConsumerState<RentMachineryScreen> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style:
                    AppTextStyle.latoStyle(size: 10, color: AppColors.darkGrey),
              ),
            ),
            Align(
              alignment: const AlignmentDirectional(-1.00, 0.00),
