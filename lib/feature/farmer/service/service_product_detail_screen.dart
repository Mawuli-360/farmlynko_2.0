...
class ServiceProductDetailScreen extends ConsumerStatefulWidget {
  const ServiceProductDetailScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<ServiceProductDetailScreen> createState() =>
      _ServiceProductDetailScreenState();
}

class _ServiceProductDetailScreenState
    extends ConsumerState<ServiceProductDetailScreen> {
  @override
